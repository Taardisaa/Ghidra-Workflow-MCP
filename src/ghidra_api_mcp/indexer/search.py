...
class WorkflowSearcher:
    ...
    def get_api_doc(self, name: str, n_results: int = 5) -> list[dict]:
        ...
        """
        # Try exact ID match (class name is used as the ID)
        try:
    ...
    def list_related_apis(self, class_name: str) -> dict:
        ...
        # Use semantic search to find workflows related to this class,
        # then filter to those that actually mention it in classes_used
        results = self._workflows.query(
